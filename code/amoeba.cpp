...
#include "minfuncs.h"
    ...
    struct Amoeba {
        ...
        template <class T>
        vector<double> minimise(vector<double> &point, const double del, T &func) {
        ...
        template <class T>
        vector<double> minimise(vector<double> &point, vector<double> &dels, T &func) {
        ...
        template <class T>
        vector<double> minimise(MatDoub &pp, T &func) {
            ...
            for (;;) {
                ...
                if ( nfunc >= NMAX ) cerr << "Too many iterations" << endl;
                nfunc += 2;
        ...
        inline void get_psum(MatDoub &p, vector<double> &psum) {
        ...
        template <class T>
        double amotry(MatDoub &p, vector<double> &y, vector<double> &psum, const int ihi, const double fac, T &func) {
